...
class AhmedBody_AllObservations(PlatformEnvironment):
    ...
    def __init__(self):
        ...
        self.baseline_duras = 2 # Calculate baseline for 0.02 * baseline_duras seconds
    ...
    def reset(self) -> np.ndarray:
        ...
        self.history_parameters["baseline_drag"] = RingBuffer(2000)
        self.history_parameters["baseline_lift"] = RingBuffer(2000)
        self.history_parameters["baseline_side"] = RingBuffer(2000)
