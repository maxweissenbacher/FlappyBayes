...
class AhmedBody_AllObservations(PlatformEnvironment):
    ...
    def __init__(self):
        ...
        self.size_history = 2000 # Size of the RingBuffer
        self.nstack = 20 # The number of framestack
        ...
        self.flap_behavior = 'snaking' #Whether use snaking, clapping, free
    ...
    def write_history_parameters(self):
        ...
        for num_sensors in range(7):
            ...
            print(type(self.previous_pressure[num_sensors]))
        ...
        for num_flaps in range(4):
            ...
            print("volt", type(self.previous_voltage[num_flaps]))
            ...
            print(type(self.previous_action[num_flaps]))
    ...
    def step(self, action):
        ...
        self.reward = - np.sum(current_power) + (abs(baseline_ForceX) - abs(current_ForceX)) * Velocity
